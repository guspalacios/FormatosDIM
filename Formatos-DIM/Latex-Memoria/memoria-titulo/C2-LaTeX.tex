...
A partir de los datos consolidados en la revision de \cite{AhmadvashAghbash2024IMR}, los rangos típicos
son:

\begin{itemize}
    \item \textbf{SFFT:} 30–100 MPa.
    \item \textbf{Microbond:} 30–90 MPa.
    \item \textbf{Push-Out / Push-In:} 10–80 MPa.
    \item \textbf{SFPO:} 20–50 MPa.
    \item \textbf{FBPO:} 15–40 MPa. \cite{DeLeon2022}.
    \item \textbf{ILSS:} 40–80 MPa.
    \item \textbf{Iosipescu:} 30–60 MPa.
\end{itemize}
...
\subsubsection{Naturaleza aparente vs.\ real de la IFSS}
